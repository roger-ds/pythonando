...
urlpatterns = [
    ...
    path(
        "gerenciar_pedidos/", views.gerenciar_pedidos, name="gerenciar_pedidos"
    ),
    path(
    ...
    path(
        "solicitar_senha_exames/<int:exame_id>",
        views.solicitar_senha_exames,
        name="solicitar_senha_exames",
    ),
    path(
        "gerar_acesso_medico",
